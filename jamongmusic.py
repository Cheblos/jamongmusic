...
def title(msg):
    ...
    chromedriver_dir = "D:\chromedriver\chromedriver.exe"
...
async def on_ready():
    ...
    await bot.change_presence(status=discord.Status.online, activity=discord.Game("Jamong!!!"))
...
async def c(ctx):
    try:
        ...
        try:
            ...
            await ctx.send('채널에 유저가 입장해야 합니다.')
...
bot.run('ODg5MTUyNDI5MzAyNjI0MzE3.YUdFug.wYRIoymhM2m-OjIcNnFxm8AFNqU')
